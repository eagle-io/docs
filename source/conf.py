# -*- coding: utf-8 -*-
#
# eagle.io documentation build configuration file, created by
...
latex_documents = [
  ('index', 'eagleio.tex', u'eagle.io documentation',
   u'Bentley Systems, Incorporated', 'manual'),
]
...
man_pages = [
    ('index', 'eagleio', u'eagle.io documentation',
     [u'Bentley Systems, Incorporated'], 1)
]
...
texinfo_documents = [
  ('index', 'eagleio', u'eagle.io documentation',
   u'Bentley Systems, Incorporated', 'eagleio', 'One line description of project.',
   'Miscellaneous'),
]
