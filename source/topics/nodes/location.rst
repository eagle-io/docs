...
The coordinates drop down displays a list of Sources (within the Location) that can be used to dynamically update the Location latitude and longitude.
Select *Fixed Location* for manual positioning of the location on the map.
