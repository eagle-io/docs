...
^^^^^^^^^^^^^^
    ...
    *TCP Server*
        ...
        TCP Server is for use with WaterLog Storm3 data loggers, SensorLog and Waspmotes. You should configure your logger to establish a TCP connection to **device.eagle.io**

        * WaterLog Storm3 should use port **32213**
        * SensorLog should use port **80**
        * Waspmotes should use port **5566**
